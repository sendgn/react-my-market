...
function PageProduct() {
    return (
        <div className="font">
                ...
                <div className="header__container container">
                    ...
                    <div className="header__icons">
                        <div className="header__icon icon">
                            ...
                            <div className="icon__counter">12</div>
                        </div>
                        <div className="header__icon icon">
            ...
            {/* BREADCRUMBS */}
            <nav className="breadcrumbs container css css_margin_top_after-header css_margin_bottom_sm">
            ...
            <main className="product container">
                ...
                <div className="product__body">
                    ...
                    <div className="product__sidebar">
                        ...
                        {/* Advertisement */}
                        <div className="ads">
                            <div className="ads__title">Реклама</div>
                            <div className="ads__content">
                                <iframe className="iframe" src="./ads.html">
                                <p className="iframe__placeholder">Произошла ошибка при загрузке контента.</p>
                                </iframe>
                                <iframe className="iframe" src="./ads.html">
                                    <p className="iframe__placeholder">Произошла ошибка при загрузке контента.</p>
                                </iframe>
